...
def get_headless_driver():
    ...
    chrome_options.add_argument('--headless=new')  # or '--headless' depending on your ChromeDriver version
    ...
    # Create a unique temp directory for user data dir per session
    user_data_dir = tempfile.mkdtemp(prefix='chrome-user-data-')
    chrome_options.add_argument(f'--user-data-dir={user_data_dir}')
    
    # Optional: disable first run and other flags
    chrome_options.add_argument('--disable-first-run')
    chrome_options.add_argument('--disable-background-networking')
    
    driver = webdriver.Chrome(options=chrome_options)
    
    # Clean up user_data_dir after driver quits
    # This requires you to handle driver.quit() in your code properly, for example:
    #try:
    #   do stuff
    #finally:
    #   driver.quit()
